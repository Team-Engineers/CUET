        ...
        {!auth?.user ? (
            <>
                ...
                <NavLink
                  to={"/signup"}
                  className={
                    "text-sm md:text-lg whitespace-nowrap font-medium text-white bg-salmon-200 hover:bg-salmon-200 no-underline rounded-full py-2 border-solid border-2 md:py-3 md:px-6"
                  }
                >
...
>>>>>>> Stashed changes
            ...
            <li className="h-[1vh] top-[-25px] relative">
              {!auth?.user ? (
                ...
                <>
                  <ul className="menu max-lg:hidden lg:menu-horizontal relative top-[-7px]    rounded-box ">
                    <li>
                      <details open={detailsOpen} onClick={() => setDetailsOpen(!detailsOpen)}>
                        <summary>
                          <div className="rounded font-bold text-white relative text-[20px] w-10 h-10 flex items-center justify-center bg-salmon-200 border ">
                        ...
                        <ul className="relative  bg-white top-[2.2rem]  left-[3.2rem]">
                          <li>
                            <NavLink
                              to="/profile"
                              className="font-medium text-black no-underline"
