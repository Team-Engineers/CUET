...
const TopicContainer = ({ brick, heading }) => {
  ...
  return (
    <div onClick={() => navigate("/learning")} className=" flex flex-col items-center justify-center pt-10 pb-[33px] pr-[76px] pl-[75px] box-border relative gap-[28px] text-center text-13xl text-black font-inter">
