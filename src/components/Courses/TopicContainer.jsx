...
const TopicContainer = ({ brick, heading }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col absolute  p-4   rounded-xl shadow-[10px_4px_4px_rgba(0,_0,_0,_0.25)] h-[250px] w-[230px]  justify-center items-center m-[10px] text-center" />
      <img
