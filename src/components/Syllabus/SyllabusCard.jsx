  ...
  return (
    <div className=" border-2 m-4 rounded-xl shadow-[7px_7px_7px_0px_rgba(0,_0,_0,_0.25)] bg-white ">
      <div className="flex flex-col p-4 items-center justify-evenly text-center">
        ...
        <button onClick={handleButtonClick} className="cursor-pointer rounded-full max-md:text-[1.8vw] text-lg border-none bg-indigo text-white px-5 py-3 font-bold shadow-lg shadow-gray-600">
          View/ Download PDF
        </button>
      </div>
