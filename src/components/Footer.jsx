  ...
  return (
    ...
    >
      <div className=" pt-4 w-full max-md:mx-5 ">
        <div className="flex my-6 justify-center items-center">
          <div className=" grid md:grid-cols-2 md:mx-10 grid-cols-1">
            ...
            <div className="w-full  relative md:top-[20px] grid grid-cols-2 md:grid-cols-3  text-sm md:text-md">
              ...
              <div className="min-w-[10em] mx-auto my-5 md:my-0 md:ml-0">
                <p className="md:text-center font-bold mb-10 hover:text-red-500">
                  Whom we serve
                </p>
              ...
              <div className="min-w-[10em]   mx-auto my-5 md:hidden">
                ...
                <p className="my-3 md:text-center max-sm:text-[12px]">
                  Terms & Conditions
                </p>
                <p className="my-3 md:text-center max-sm:text-[12px]">
                  Privacy
        ...
        {/* here due to horizontal line , x axis scroll is coming , only for that , their is overflow hidden */}
        <div className="hidden overflow-hidden md:flex mx-auto flex-col my-3 items-start justify-start py-0 px-px box-border gap-[15px] max-w-full ">
