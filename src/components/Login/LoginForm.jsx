  ...
  return (
    <>
      <div className="md:w-[30vw]">
        ...
        <form action="" className="flex flex-col items-center justify-center mt-5 md:items-start" onSubmit={e => e.preventDefault()}>
          <div className="flex flex-col">
            {" "}
            <label htmlFor="username" className=" text-start font-bold  text-gray-700 text-[15px] sm:text-[18px]">
              Username or Email
            </label>
            <input
              required
          ...
          <div className="flex flex-col">
            <label htmlFor="password" className="mt-4  md:mt-5 text-start font-bold  text-gray-700 text-[15px] sm:text-[18px]">
              Password
            </label>
            <input
              required
          ...
          <div className="text-sm flex gap-2 w-80 md:ml-5">
            ...
            <p type="button" className="font-medium text-blue-600 underline hover:text-blue-500 text-[15px]" onClick={handleForgotPassword}>
              forgot password?
            </p>
          </div>
