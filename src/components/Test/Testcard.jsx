...
export const Testcard = ({
  ...
  return (
    <div
      ...
      className={`flex transition-all duration-100 border-solid border-[0.5px] shadow-xl hover:scale-[105%]  border-black flex-col justify-around items-center  bg-white rounded-3xl`}
    >
      <div
        style={{ background: bgcolor }}
        className="w-[95%] h-[300px] mt-3 rounded-2xl text-white flex justify-center relative"
      >
        {index === 0 && !auth.user && (
          <img
            src={freeicon}
...
export const Testcard1 = ({
  ...
  return (
    <div
      ...
      className="transition-all duration-100 hover:scale-[105%] rounded-3xl"
    >
        ...
        <div className="rounded-[20px] px-7 pb-4 mt-2 bg-white w-[70%] mx-auto h-[45%] flex flex-col items-center justify-center">
          ...
          <div className="w-full flex gap-3 items-center justify-around">
            <div className="flex justify-center items-center text-[10px]">
              <FaQuestion
                size={16}
                className="mr-1 text-white bg-[#5648FC] rounded-full p-2"
              />
              {Questions} <br />
              Questions
            </div>
    ...
    <div className="flex flex-col shadow-blue-500 transition-all duration-100 border-solid border-[0.5px] shadow-lg hover:scale-[105%] border-black bg-white rounded-[20px] items-center justify-around w-full md:w-[350px] h-[350px]">
      <div className="w-full flex relative flex-row items-center">
        {index === 0 && !auth.user && (
          <img
            src={freeicon}
            className="absolute top-[-25px] right-[-20px] w-[80px] h-[80px]"
            alt="Free Icon"
          />
        )}
        <img
          ...
          className="w-28 h-28"
        />
        <h5 className="font-bold md:text-3xl text-xl ">{subTopic}</h5>
      </div>
      ...
      <div className="w-full flex justify-center">
        <div className="w-[90%] grid grid-cols-2 gap-x-7 gap-y-10 pl-3">
          <div className="flex justify-start items-center text-lg">
            <FaQuestion
              size={36}
              className="mr-2 text-white bg-[#5648FC] rounded-full p-2"
            />
            {Questions} <br />
            Questions
          </div>
