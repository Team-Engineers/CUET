...
const SignupForm = () => {
  ...
  return (
      <div className="max-w-[30rem] w-full px-8 rounded-md Laptops:w-[22rem]tablets:w-full mt-2">
        <div>
          <h2 className="text-start text-4xl font-semibold text-[#5648FC] tablets:hidden mb-4">
            Sign-Up
          </h2>
        </div>
        <form className="" onSubmit={(e) => e.preventDefault()}>
          <div>
            <label
              htmlFor="name"
              className="block text-start text-[24px] sScreens:text-lg text-gray-700"
            >
              Name
            </label>
            <input
          ...
          <div>
            <label
              htmlFor="email"
              className="block my-2 text-start text-[24px]  text-gray-700 sScreens:text-lg"
            >
              Email
            </label>
            <input
          ...
          <div>
            <label
              htmlFor="password"
              className="block text-md my-2 text-[24px] text-gray-700 sScreens:text-lg"
            >
              Password
            </label>
            <input
