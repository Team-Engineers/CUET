...
const LoginForm = () => {
  ...
  return (
    <div className="max-w-[24rem] w-full p-8 tablets:py-0 rounded-md my-20 tablets:my-0">
      <div>
        <h2 className="mt-2 text-start text-4xl font-semibold text-[#5648FC] tablets:hidden">
          Login
        </h2>
      </div>
